  ...
  <<
    ...
    <<
      ...
      <<
        ...
        \transposition ees'
        \transpose ees bes, \RBTTptOne
      >>
      \tag #'tpt \new Staff \with { instrument = #"Tpt2(C)" instr = #"Tpt2(C)" } 
      <<
        \set Staff.instrumentName = \markup { "Tpt2 (B" \flat ")" }
        \set Staff.midiInstrument = "trumpet"
        #(set-accidental-style 'modern)
        \RBTTptTwo
      >>
